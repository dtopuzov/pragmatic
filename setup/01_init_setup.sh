...
##############################################################
# Initial setup of OS before install any of the products.
#
# Linux & macOS Actions:
# - Create log folder at user home
# - Create clean `~/.bash_profile` profile to keep settings
#
# macOS Specific Actions:
# - Enable current user to run `sudo` without password prompt
